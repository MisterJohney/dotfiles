...
"Plug 'tpope/vim-surround'	Not nessecary rn because I have it with another plugin
Plug 'preservim/nerdtree'
"Plug 'jreybert/vimagit'	Not using git rn
...
set signcolumn=yes
  ...
  " Use <C-e> and <Return> to cancel and confirm completion: >
